...
## noqa NOTE:in order to get the details of a particular recipe we use a method instead of constant shown above
def detail_url(recipe_id):
    """Create and return a recipe detail URL."""
    ## noqa NOTE: Generates unique URL for specific recipe's detail enpoint
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_get_recipe_detail(self):
        ...
        ## noqa NOTE: Creates a custome url for given recipe.id
    ...
    def test_create_recipe(self):
        """Test create recipe."""
        ## noqa NOTE: send a payload to the actual API
        payload = {
            'title': 'Sample recipe',
            'time_minutes': 30,
            'price': Decimal('5.99'),
    ...
    def test_partial_update(self):
        """Test partial update."""
        ## noqa NOTE: update a part of obj.
    ...
    def test_create_recipe_with_ingredients(self):
        """Test crateing a recipe with new ingredients."""
        payload = {
    ...
    def test_create_ingredient_on_update(self):
        ...
        ## noqa Does this take the already fetched ingredients resulting in fail
        ## noqa Or does th recipe.ingredients call for the db once more.
    ...
    def test_filter_by_ingredients(self):
        """Test filtering recipes by ingreadients."""
...
class ImageUploadTests(TestCase):
    ...
    def test_upload_image_bad_reqeust(self):
